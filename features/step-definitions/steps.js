...
When('I click create greetings promotion', async () => {
    await PromotionPage.createGreetingsPromotionButton.waitForDisplayed();
    await PromotionPage.createGreetingsPromotionButton.click();
})

When('I input greetings promotion data', async () => {
    await PromotionPage.selectGreetingPriority('1');
    await PromotionPage.selectRadioGreeting('Баллы')
    await PromotionPage.inputGreetingPoint('1');
})
